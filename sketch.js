...
eyesImage = loadImage("eye-of-insolence.png");
...
background2 = createSprite(1050,328.5,windowWidth,windowHeight)
guy1 = createSprite(30,590,100,100);

ground = createSprite(659,652,1318,10)
...
function spawnEyes() {
  ...
  if (frameCount % 60 === 0) {
    var eyes = createSprite(600,950,40,10);
    eyes.y = Math.round(random(80,950));
